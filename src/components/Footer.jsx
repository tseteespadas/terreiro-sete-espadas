        ...
        <div className="content">
          <div className="col">
            <div className="redes-sociais">
              ...
              <div>
                <a target="_blank" href="https://www.instagram.com/jeff_sarti/" rel="noopener noreferrer">
                  <FontAwesomeIcon icon={["fab", "instagram-square"]} />
                  <p>@jeff_sarti</p>
                </a>
              </div>
              <div>
                <a target="_blank" href="https://mail.google.com/mail/" rel="noopener noreferrer">
